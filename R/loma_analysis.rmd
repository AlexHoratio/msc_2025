...
read_statistics <- get_tsv_from_run_folder("/data/loma/output_ex64/RUN01/")
...
assembly_stats <- get_all_assembly_stats("data/loma/RUN01")
...
bases_bincount <- ggplot(filtered_read_statistics, aes(x = total_bases_mbp, y = bin_count)) + 
  geom_point()
...
in_out_n50 <- ggplot(filtered_read_statistics, aes(x = read_n50, y = average_bin_n50)) + 
  geom_point()
...
plot_grid(bases_bincount, in_out_n50, labels = c("A", "B"))
...
bin_n50 <- ggplot(read_statistics, aes(x = run_accession, y = round(average_bin_n50/1000), fill = run_accession)) + 
  geom_bar(stat="identity", show.legend = TRUE) +
