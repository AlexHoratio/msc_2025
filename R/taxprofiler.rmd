...
all_abundances_with_species[, c(2, 3, 4, 5, 6, 7, 9, 10, 11, 12, 13, 14, 16, 17, 18, 19, 20, 21)][is.na(all_abundances_with_species[, c(2, 3, 4, 5, 6, 7, 9, 10, 11, 12, 13, 14, 16, 17, 18, 19, 20, 21)])] <- 0

species_proportions <- aggregate(. ~ species, all_abundances_with_species[, -c(1, 8, 15, 22)], sum, na.rm = TRUE)

centrifuger_species_proportions <- species_proportions[,c(1, 14:19)]
...
bracken_hrgm2_species_proportions <- species_proportions[,c(1, 8:13)]
colnames(bracken_hrgm2_species_proportions) <- c("species", "R003", "R004", "R005", "R007", "R012", "R018")


species_proportions <- rbind(
  bracken_species_proportions %>% add_column(profiler=c("Bracken")),
  bracken_hrgm2_species_proportions %>% add_column(profiler=c("Bracken (HRGM2)")),
