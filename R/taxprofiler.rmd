...
prepareDatabase('data/accessionTaxa.sql', types = c("nucl_gb", "nucl_wgs"), protocol="http", getAccessions = TRUE)
...
ggsave("graphs/taxprofiler/compare_phyla_thesis.png", compare_phyla_thesis, width = 2187, height = 1200, units="px")
...
ggsave("graphs/taxprofiler/compare_domains_thesis.png", compare_domains_thesis, width = 2187, height = 1200, units="px")
...
ggsave("graphs/taxprofiler/compare_classes.png", compare_classes, width = 2187, height = 1200, units="px")
compare_classes
...
ggsave("graphs/taxprofiler/compare_orders.png", compare_orders, width = 2187, height = 1200, units="px")
compare_orders
...
remainder <- aggregate(. ~ profiler+name, genus_proportions[genus_proportions$value <= 0.04,][, -c(1)], sum) %>%
  add_column(genus=c("<4% Genuses"))
...
compare_genus <- ggplot(genus_proportions, aes(x=name, y=value, fill=genus)) + 
  ...
  xlab("") +
  ylab("") +
  ggtitle("<b>Distribution of Genuses</b> (k-mer classification)") +
  labs(fill = "Genus")+
  scale_y_continuous(labels = scales::percent, breaks=c(0, 1)) +
...
ggsave("graphs/taxprofiler/compare_genus.png", compare_genus, width = 2187, height = 2000, units="px")
compare_genus
...
remainder <- aggregate(. ~ profiler+name, species_proportions[species_proportions$value <= 0.04,][, -c(1)], sum) %>%
  add_column(species=c("<4% Species"))
...
ggsave("graphs/taxprofiler/compare_species.png", compare_species, width = 2187, height = 2000, units="px")
compare_species
